...
element_info = {
    ...
    # Block-level
        ...
        'emu-note'             : ('B', '',          'class id',   '#WS;((div;|emu-alg;|emu-grammar;|emu-table;|figure;|p;|pre;|ul;)#WS;)*|(#TEXT;|a;|emu-not-ref;|emu-xref;)+'),
        ...
        'dd'                   : ('B', '',          '',           '#WS;((p;|ul;)#WS;)+|(#TEXT;|a;|code;|dfn;|emu-eqn;|emu-xref;|i;|sub;|sup;)+'),
