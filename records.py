...
def extract_record_schemas():
    ...
    record_schema.add_field_decl(FieldDecl('[[Getter]]',       'a function object or *undefined*', ''))
    record_schema.add_field_decl(FieldDecl('[[Setter]]',       'a function object or *undefined*', ''))
